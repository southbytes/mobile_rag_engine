...
void main() {
  test('Smart Error Handling - Verify DatabaseError on missing pool', () async {
    // 1. Initialize FFI
    await RustLib.init();
  ...
  test('Smart Error Handling - Verify RagError on Search without DB', () async {
...
extension type extension_RagError(RagError e) implements RagError {}
